...
if __name__ == '__main__':
	...
	#perform ramsey sequence to measure larmor frequency
	detuning_range = 20 #Hz
	...
	# precession_time = (1/10)*(1/detuning_range) #lets us observe a two hertz of drift as 2pi/10 radians.
	t += wait(calibration_precession_time)
