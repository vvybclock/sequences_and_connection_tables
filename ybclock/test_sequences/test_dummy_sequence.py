...
'''
The idea is to define global variables in runmanager, and call theme here!

For example: it would be usefull and practical to be able to define ramp parameters for Rabi scan in globals like:
...
stop(t)
print("Compiled test_empty_cavity_sequence!")